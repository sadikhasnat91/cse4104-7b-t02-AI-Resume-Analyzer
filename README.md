...
Although several resume analysis tools exist, they are often limited. Many lack advanced AI capabilities, fail to provide personalized or job-specific recommendations, and are either paid or not beginner-friendly. As a result, users do not receive comprehensive and actionable feedback to effectively improve their resumes.
...
- To identify missing or weak skills in the resume  
- To provide personalized suggestions for improving the resume  
- To recommend suitable job roles based on the candidate’s profile and skills  
- To build a user-friendly mobile application using Flutter for easy interaction  
...
**Backend:**  
- Supabase (Used to build scalable backend services)

**Artificial Intelligence:**  
- OpenAI API / Gemini API (For resume analysis and suggestions)

**Database:**  
- Supabase / MongoDB (For storing user data and analysis results)
